...
abstract sig Position { row : one Int, col : one Int, diagonal1 : one Int, diagonal2 : one Int, score1 : one Int, score2 : one Int, score3 : one Int }
...
abstract sig Board { pieces : set Queen, positions : set Position, score1 : one Int, score2 : one Int, score3 : one Int }
