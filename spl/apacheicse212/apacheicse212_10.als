...
pred featureSet
{
  ...
  Base in Apache.features
  HostnameLookups not in Apache.features
  KeepAlive not in Apache.features
  EnableSendfile not in Apache.features
  FollowSymLinks not in Apache.features
  ExtendedStatus not in Apache.features
  InMemory in Apache.features
