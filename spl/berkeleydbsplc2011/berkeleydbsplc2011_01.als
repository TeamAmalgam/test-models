...
pred featureSet
{
  ...
  HAVE_HASH not in BerkeleyDbC.features
  HAVE_QUEUE in BerkeleyDbC.features
  HAVE_REPLICATION in BerkeleyDbC.features
  HAVE_VERIFY not in BerkeleyDbC.features
  HAVE_SEQUENCE in BerkeleyDbC.features
  DIAGNOSTIC not in BerkeleyDbC.features
  SYNTHETIC_BASE_FEATURE in BerkeleyDbC.features
}
