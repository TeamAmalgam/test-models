...
pred featureSet
{
  ...
  ServerRoster in PKJab.features
  XEP0085 not in PKJab.features
  Composing not in PKJab.features
  SendComposing not in PKJab.features
  History not in PKJab.features
  XEP0092 in PKJab.features
  SendVersion not in PKJab.features
  ThemeSelection in PKJab.features
}
