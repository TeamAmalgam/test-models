...
pred featureSet
{
  ...
  SQLITE_SECURE_DELETE in Sqlite.features
  ...
  SQLITE_ENABLE_MEMSYS5 in Sqlite.features
  ...
  SQLITE_OMIT_ANALYZE not in Sqlite.features
  ...
  SQLITE_OMIT_EXPLAIN in Sqlite.features
  ...
  SQLITE_OMIT_TRACE not in Sqlite.features
  ...
  SQLITE_OMIT_WAL in Sqlite.features
}
