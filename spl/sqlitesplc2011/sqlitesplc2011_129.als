...
pred featureSet
{
  ...
  // Define the partial configuration here:
	SQLITE_4_BYTE_ALIGNED_MALLOC in Sqlite.features
  SQLITE_CASE_SENSITIVE_LIKE not in Sqlite.features
  SQLITE_HAVE_ISNAN not in Sqlite.features
  ChooseSQLITE_TEMP_STORE in Sqlite.features
  SQLITE_TEMP_STORE_EQ_0 not in Sqlite.features
  SQLITE_TEMP_STORE_EQ_1 in Sqlite.features
  SQLITE_TEMP_STORE_EQ_2 not in Sqlite.features
  SQLITE_TEMP_STORE_EQ_3 not in Sqlite.features
  SQLITE_ENABLE_COLUMN_METADATA not in Sqlite.features
  SQLITE_ENABLE_FTS3_PARENTHESIS not in Sqlite.features
  SQLITE_ENABLE_MEMORY_MANAGEMENT not in Sqlite.features
  ChooseMemSys in Sqlite.features
  SQLITE_ENABLE_MEMSYS3 in Sqlite.features
  ...
  SQLITE_ENABLE_UNLOCK_NOTIFY in Sqlite.features
  YYTRACKMAXSTACKDEPTH not in Sqlite.features
  SQLITE_DISABLE_LFS not in Sqlite.features
  OmitFeatures in Sqlite.features
  SQLITE_OMIT_ALTERTABLE in Sqlite.features
  SQLITE_OMIT_ANALYZE in Sqlite.features
  SQLITE_OMIT_AUTHORIZATION not in Sqlite.features
  SQLITE_OMIT_BETWEEN_OPTIMIZATION in Sqlite.features
  SQLITE_OMIT_BLOB_LITERAL not in Sqlite.features
  SQLITE_OMIT_BTREECOUNT not in Sqlite.features
  SQLITE_OMIT_CAST not in Sqlite.features
  ...
  SQLITE_OMIT_DECLTYPE in Sqlite.features
  SQLITE_OMIT_DEPRECATED not in Sqlite.features
  SQLITE_OMIT_EXPLAIN not in Sqlite.features
  SQLITE_OMIT_FLAG_PRAGMAS in Sqlite.features
  ...
  SQLITE_OMIT_LIKE_OPTIMIZATION in Sqlite.features
  SQLITE_OMIT_LOAD_EXTENSION in Sqlite.features
  SQLITE_OMIT_LOCALTIME not in Sqlite.features
  SQLITE_OMIT_LOOKASIDE in Sqlite.features
  SQLITE_OMIT_MEMORYDB not in Sqlite.features
  SQLITE_OMIT_PAGER_PRAGMAS in Sqlite.features
  ...
  SQLITE_OMIT_SCHEMA_VERSION_PRAGMAS not in Sqlite.features
  SQLITE_OMIT_SUBQUERY in Sqlite.features
  ...
  SQLITE_OMIT_TRUNCATE_OPTIMIZATION not in Sqlite.features
  SQLITE_OMIT_VACUUM in Sqlite.features
  SQLITE_OMIT_VIRTUALTABLE in Sqlite.features
  SQLITE_OMIT_WAL not in Sqlite.features
  SQLITE_OMIT_XFER_OPT not in Sqlite.features
