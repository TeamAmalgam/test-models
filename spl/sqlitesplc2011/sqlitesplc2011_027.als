...
pred featureSet
{
  ...
  SQLITE_ENABLE_FTS3 in Sqlite.features
  SQLITE_ENABLE_MEMORY_MANAGEMENT in Sqlite.features
  SQLITE_ENABLE_MEMSYS3 in Sqlite.features
  SQLITE_ENABLE_STAT2 in Sqlite.features
  SQLITE_ENABLE_UNLOCK_NOTIFY in Sqlite.features
  SQLITE_SOUNDEX in Sqlite.features
  DisableFeatures in Sqlite.features
  SQLITE_DISABLE_LFS not in Sqlite.features
  SQLITE_DISABLE_DIRSYNC not in Sqlite.features
  SQLITE_OMIT_ALTERTABLE in Sqlite.features
  SQLITE_OMIT_ATTACH not in Sqlite.features
  SQLITE_OMIT_AUTHORIZATION in Sqlite.features
  SQLITE_OMIT_AUTOINCREMENT not in Sqlite.features
  SQLITE_OMIT_AUTOMATIC_INDEX not in Sqlite.features
  SQLITE_OMIT_AUTOINIT in Sqlite.features
  ...
  SQLITE_OMIT_CAST in Sqlite.features
  ...
  SQLITE_OMIT_LOAD_EXTENSION not in Sqlite.features
  ...
  SQLITE_OMIT_PRAGMA in Sqlite.features
  ...
  SQLITE_OMIT_TCL_VARIABLE in Sqlite.features
  SQLITE_OMIT_TEMPDB in Sqlite.features
  SQLITE_OMIT_TRIGGER not in Sqlite.features
  SQLITE_OMIT_VACUUM not in Sqlite.features
  SQLITE_DEBUG in Sqlite.features
  SQLITE_MEMDEBUG not in Sqlite.features
}
