...
pred featureSet
{
  ...
  // Define the partial configuration here:
	SQLITE_4_BYTE_ALIGNED_MALLOC in Sqlite.features
  SQLITE_CASE_SENSITIVE_LIKE in Sqlite.features
  ...
  SQLITE_OMIT_ATTACH in Sqlite.features
  ...
  SQLITE_OMIT_AUTOVACUUM in Sqlite.features
  ...
  SQLITE_OMIT_FLOATING_POINT in Sqlite.features
  ...
  SQLITE_OMIT_QUICKBALANCE not in Sqlite.features
