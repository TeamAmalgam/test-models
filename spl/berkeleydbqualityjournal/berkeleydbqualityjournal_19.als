...
pred featureSet
{
  ...
  HAVE_CRYPTO not in BerkeleyDbC.features
  BTREE_SMALL not in BerkeleyDbC.features
  HAVE_REPLICATION in BerkeleyDbC.features
  HAVE_VERIFY in BerkeleyDbC.features
  DIAGNOSTIC in BerkeleyDbC.features
  HAVE_SEQUENCE not in BerkeleyDbC.features
}
