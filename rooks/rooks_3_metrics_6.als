...
abstract sig Position { row : one Int, col : one Int, score1 : one Int, score2 : one Int, score3 : one Int, score4 : one Int, score5 : one Int, score6 : one Int }
...
abstract sig Board { pieces : set Rook, positions : set Position, score1 : one Int, score2 : one Int, score3 : one Int, score4 : one Int, score5 : one Int, score6 : one Int }
